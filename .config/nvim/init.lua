...
vim.keymap.set('n', '<leader>sa', require('telescope.builtin').lsp_workspace_symbols, { desc = '[S]earch Workspace Symbols' })
vim.keymap.set('n', '<leader>sk', require('telescope.builtin').keymaps, { desc = 'Search [K]maps' })
